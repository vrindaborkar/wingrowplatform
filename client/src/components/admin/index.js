...
const SectionHeader = ({ title, icon }) => (
    <div className="h-2rem mx-4 lg:mx-0 lg:w-20rem lg:justify-content-end text-white py-1 font-bold border-round-md"
        style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }}>
...
const CustomProgressBar = ({ progress }) => (
    <div className='lg: w-30rem ' style={{
        width: '111.13px',
        height: '18px',
...
const InfoBox = ({ title, amount }) => (
    ...
    <div className="h-3rem bg-green-600 w-full md:w-7rem lg:w-30rem py-3 text-white text-center font-bold border-round-md px-2"
         style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }}>
        {amount}
    </div>
</div>
...
const FarmerTypeItem = ({ count, label }) => (
    <div className="flex align-items-center justify-content-between gap-2">
        <p className='h-2rem w-2rem border-2 border-green-400 text-center border-circle py-1'>{count}</p>
        ...
        <Container >
                ...
                <Col>
                    ...
                    <div className="border border-round-md p-3 border-green-400">
                        <Row className="justify-content-between">
                            <ProgressCircle value={first} text={`${first}`} label="Total Markets" />
                            <ProgressCircle value={secondValue} text={`${second}`} label="Stalls Booked" />
                        </Row>
                        <div style={{ borderTop: '1px dotted #3aa64c', width: '100%', margin: '10px 0' }}></div>
                        <div className="font-bold my-2 ">
                            <b>Quantity</b>
                            <hr className="w-6rem" />
                        </div>
                        <div className="d-flex justify-content-around  gap-3">
                            <div className='lg:w-30rem'>Purchase: <b>2,70,196 Kgs</b></div>
                            <div className='lg:w-30rem'>Sale: <b>2,60,639 Kgs</b></div>
                        </div>
                        ...
                        <div className="d-flex justify-content-center">
                            <Chart type="pie" data={chartData} options={chartOptions} className="h-10rem" />
                        </div>
                    </div>
                </Col>
            </Row>
                ...
                <Col>
                    ...
                    <div className="border flex gap-3 border-round-md p-3 border-green-400 align-items-center justify-content-center">
                        <div className="flex justify-content-center align-items-center">
                            <div className="w-5rem h-5rem border-circle text-white flex align-items-center justify-content-center text-sm" style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }}>
                                12600
                            </div>
                        </div>
            ...
            <Row>
                <Col>
                    ...
                    <div className="border flex gap-3 border-round-md p-3 border-green-400 align-items-center justify-content-center">
                        <div className="flex justify-content-center align-items-center">
                            <div className="w-5rem h-5rem bg-green-600 border-circle text-white flex align-items-center justify-content-center text-sm" style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }}>
                                12600
                            </div>
                        </div>
                        <div className="flex justify-content-center align-items-center mt-2">
            ...
            <div className="p-fluid">
                <div className="p-grid p-justify-center p-align-center p-3">
                    <div className="flex gap-3">
                        <Button label="Farmer list" className='border-round-md' onClick={handleOnFetchFarmersRecord} style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }} />
                        <Button label="Consumer list" className='border-round-md' onClick={handleOnFetchCustomerRecord} style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }} />
                    </div>
                </div>
            </div>
            <div className="p-fluid">
                <div className="p-grid p-justify-center p-align-center p-3">
                    <div className="p-col">
                        <Button label="Cancelled stall list" className='border-round-md' onClick={handleOnFetchCustomerRecord} style={{ background: 'linear-gradient(105.42deg, #3AA54B 33.61%, #107C55 80.31%)' }} />
                    </div>
                </div>
            </div>
        </Container>
